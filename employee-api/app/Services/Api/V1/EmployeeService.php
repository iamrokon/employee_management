...
class EmployeeService
{
    ...
    public function index(Request $request): LengthAwarePaginator
    {
        ...
        // Create a unique cache key based on filters + pagination
        $cacheKey = 'employees:'
            . md5(json_encode($request->all()) . ":page_" . $request->input('page', 1));

        // Cache for 5 minutes (adjust as needed)
        return Cache::tags(['employees'])->remember($cacheKey, 300, function () use ($request, $perPage) {
